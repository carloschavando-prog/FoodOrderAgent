...
ITEMS = [
  ...
  ("Maraschino Cherries",        4, "6/0.5 GAL",  2,  1),
  ("Cholula",                    4, "24/5 OZ",   12,  1),
  ...
  ("Shortening",                 4, "35 LB",      8,  1),
  ("Croutons",                   4, "4/2.5 LB",   3,  1),
  # Disposables (cat 5)
  ("Can Liners",                 5, "5 Rolls",    3,  5),
  ("Deli Paper",                 5, "12/500",     3,  1),
  ("Straws",                     5, "4/500",      6,  5),
  ("16 oz To-Go Cold Cups",      5, "12/70 CT",   2,  3),
  ...
  ("Savaday",                    5, "2/250",      2,  1),
  ("Napkins C Fold",             5, "24 Packs",   3,  5),
  ("T-Shirt Bags",               5, "500",        1,  5),
  ("Plastic Wrap",               5, "2000'",      1,  5),
  ("Aluminum Foil Roll",         5, "18x1000",    1,  1),
  ("Pizza Boxes",                5, "50 CT",      1,  2),
  # Walk-In Cooler (cat 6)
  ("Baby Carrots",               6, "4/5 LB",  None,  1),
  ("Broccoli",                   6, "20 LB",   None,  2),
  ("Green Onions",               6, "4/2 LB",     2,  1),
  ("Cucumbers",                  6, "12 EA",   None,  2),
  ("Celery Sticks",              6, "2/5 LB",     2,  2),
  ("Shredded Lettuce",           6, "6/2 LB",     6,  2),
  ("Burger Patties",             6, "48/4 OZ",    5,  2),
  ("Double Lobe Chicken Breasts",6, "4/5 LB",     4,  1),
  ("Chicken Wings",              6, "40 LB",      7,  1),
  ("Assorted Peppers",           6, "5 LB",    None,  1),
  ("Cherry Tomatoes",            6, "10 LB",   None,  1),
  ("American Slices 120 CT",     6, "4/5#",       4,  2),
  ("Pecorino Romano Blend",      6, "4/5 LB",     1,  2),
  ("Parmesan Cheese",            6, "2/5 LB",     3,  1),
  ("Mild Cheddar Cheese",        6, "4/5 LB",  None,  1),
  ("Oranges",                    6, "88 CT",      2,  1),
  ("Limes",                      6, "48 EA",      2,  2),
  ...
  ("Pickles",                    6, "5 GAL",   0.25,  2),
  ("Bacon Toppings",             6, "2/5 LB",     2,  1),
  ("Sliced Bacon",               6, "15 LB",      3,  2),
  # Freezer (cat 7)
  ("Potato Hamburger Bun",       7, "5/12",       3,  1),
  ("Fries",                      7, "6/5 LB",    26,  2),
  ...
  ("Low Temp Sanitizer",         8, "5 LT",       2,  1),
  ("Sanitizing Floor Cleaner",   8, "1 EA",       2,  1),
  ("Quat Sanitizer",             8, "5 LT",       2,  1),
  ("Dishmachine Detergent",      8, "1 EA",       2,  1),
  ("Stainless Steel Scrubber",   8, "6/12",       1,  1),
  ("Green Scrubbies",            8, "20 EA",      1,  1),
  ("M Nitrile Gloves",           8, "10/100",    12,  5),
  ("L Nitrile Gloves",           8, "10/100",    12,  5),
  ("XL Nitrile Gloves",          8, "10/100",    12,  5),
  ("Fryer Filters",              8, "",           1,  5),
  # Beverage Dock (cat 9)
  ...
  ("Aluminum 1/3 Pans",          9, "100 EA",     4,  1),
]
...
PRICES = [
  ...
  ("Ranch Dressing",             1, "5328406", 56.46, "4/1 GA"),
  ...
  ("24 Ounce Pretzel",           1, "7765738", 56.19, "9/24 OZ"),
  ("Tater Kegs",                 1, "9760813", 38.92, "10 LB"),
  ("Tater Kegs",                 2, None,      38.77, "10 LB"),
  ("Delimer",                    1, "4367561",117.10, "4/1 GAL"),
  ("Oven Cleaner",               1, "7912660", 63.59, "6/20 oz"),
  ("Solid Dish Detergent",       1, "4000515", None,  "2/9 LB"),
  ("Degreaser",                  1, "7912694", 57.82, "6/32 oz"),
  ("Pot & Pan Detergent",        1, "1086044", None,  "1 EA"),
  ("Pre Soak",                   1, "3986002", 75.00, "5 LT"),
  ("Heavy Duty Rinse Additive",  1, "4959856", None,  "1 EA"),
  ("Low Temp Sanitizer",         1, "3742737", 28.88, "5 LT"),
  ("Sanitizing Floor Cleaner",   1, "8928261", 94.62, "1 EA"),
  ("Quat Sanitizer",             1, "1483772", 70.06, "5 LT"),
  ...
  ("Aluminum 1/3 Pans",         1, "7737075", None, "100 EA"),
